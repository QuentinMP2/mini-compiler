...
(* TESTS *)
let%test_unit _ = (analyse_lexicale "interface.txt")
let%test_unit _ = (analyse_lexicale "interface-echec-syntaxique.txt")
let%test_unit _ = (analyse_lexicale "interface-echec-semantique.txt")
let%test _ = try
...
(* TESTS *)
let%test_unit _ = (analyse_syntaxique "interface.txt")
let%test_unit _ = (analyse_syntaxique "interface-echec-semantique.txt")
let%test _ = try
...
(* TESTS *)
let%test _ =
  let (li,la) = analyse_semantique "interface.txt" in
  verifier li la
