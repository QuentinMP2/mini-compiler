...
let%expect_test "testP3" =
  runtam (pathFichiersRat ^ "testP3.rat");
  [%expect {| [1/2] |}]

let%expect_test "testP4" =
  runtam (pathFichiersRat ^ "testP4.rat");
  [%expect {| [1/2] |}]
...
let%expect_test "testP6" =
  runtam (pathFichiersRat ^ "testP6.rat");
  [%expect {| 423 |}]

let%expect_test "testP7" =
  runtam (pathFichiersRat ^ "testP7.rat");
  [%expect {| [22/15] |}]
